# ML_laboratory_1
Лабораторная работа №1. Проектирование систем интеллектуального анализа промышленных данных.
...
- Точность модели с оптимизатором AdamW составила 57%.
  

Результаты экспериментов показали, что оптимизатор AdamW продемонстрировал лучшую устойчивость к эффекту плато и оказался более эффективным в условиях сложной многоклассовой классификации. Его использование способствовало более стабильному и глубокому обучению модели. В отличие от него, Adam проявил себя менее успешно, вероятно, из-за высокой сложности задачи, особенностей начальной инициализации и отсутствия предобученных весов. Анализ графиков обучения подтверждает это: модель, обучаемая с использованием AdamW, продолжала уверенно улучшать свои показатели на протяжении всех 30 эпох, тогда как при использовании Adam прогресс заметно замедлился уже после 25 эпох.
